...
# Read the benchmarking results for Dardel
csv_path = 'data_for_plotting/mpi/dardel_mpi_scaling_results.csv'
...
# Set up the figure with two subplots (Execution Time and Speedup)
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 6))

# --- Plot 1: Execution Time ---
ax1.plot(df['Processes'], df['ExecutionTime'], marker='o', linestyle='-', color='b', linewidth=2, markersize=8)
ax1.set_title('Dardel MPI Execution Time vs. Processes', fontsize=14)
...
ax2.set_title('Dardel MPI Speedup vs. Processes', fontsize=14)
...
# Save the plot
plt.tight_layout()
plot_path = 'plots/dardel_mpi_scaling.png'
plt.savefig(plot_path, dpi=300)
print(f"🎉 Dardel MPI plot successfully saved to: {plot_path}")
